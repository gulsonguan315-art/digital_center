                    ...
                    children: [
                      ...
                      ValueListenableBuilder<PlaybackPhase>(
                        ...
                        builder: (context, phase, _) {
                          if (phase.index < PlaybackPhase.buildingEngine.index) return const SizedBox.shrink();
                          return Stack(
                            children: [
                              Positioned.fill(
                                child: Video(
                                  controller: _controller.playerEngine.videoController,
                              ...
                              ValueListenableBuilder<String>(
                                ...
                                builder: (context, currentId, child) {
                                  return MediaImmersiveHud(
                                    ...
                                    virtualPositionNotifier: _controller.playerEngine.seekController.virtualPositionNotifier,
                                  );
                                },
                              ),
                            ],
                          ...
                          onTap: () {
                            if (showMenu || roomContext.useIsActive('media_home_confirm')) {
                              ...
                              if (roomContext.useIsActive('media_home_confirm') &&
                                  _controller.playbackPhase.value.index >= PlaybackPhase.buildingEngine.index &&
                                  !_controller.playerEngine.player.state.playing &&
                                  _controller.playerEngine.seekController.wasPlayingBeforeSeek) {
                        ...
                        Positioned.fill(
                          child: Container(
                            ...
                            child: MediaHomeConfirmDialog(
                              onCancel: () {
                                if (_controller.playerEngine.seekController.wasPlayingBeforeSeek) {
                                  _controller.playerEngine.player.play();
                                }
                              },
                              onConfirm:
